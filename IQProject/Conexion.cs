...
namespace IQProject
{
    class Conexion
    {
        ...
        public Conexion()
        {
            ...
            //Con1 = new SqlConnection(@"Data Source=MEX-W10-9SANKBV\SQLEXPRESS;Initial Catalog=ZodiacReg;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        }
        ...
        public DataView Leer_Datos2(string query, string tabla)
        {
            DataSet res = new DataSet();
            ...
            {
                Abrir();
                SqlDataAdapter da = new SqlDataAdapter(new SqlCommand(query, Con1));
                da.Fill(res, tabla);
                da.Dispose();
                Cerrar();
            }
